...
class Barang 
{
    ...
    {
        $query = "INSERT INTO $this->table (`kode_barang`,`nama`,`berat_barang`) VALUES ('$this->kode_barang','$this->nama','$this->berat_barang')";
        $this->db->query($query);
        return $this->db->insert_id();
    }
    public function update(int $id): int
    {
        $query = "UPDATE $this->table SET kode_barang = '$this->kode_barang', nama = '$this->nama', berat_barang = '$this->berat_barang'
        WHERE id = $id";
        $this->db->query($query);
