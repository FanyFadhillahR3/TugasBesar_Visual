...
Public Class Form_barang
    Private Sub TambahData()
        ...
        Dim berat_barang As String = txtBerat_barang.Text

        Dim postData As String = $"kode_barang={kode_barang}&nama={nama}&berat_barang={berat_barang}"
                ...
                Finally
                    If (barang_baru = False) Then
                        ...
                        For Each mydata As Barang In data
                            ...
                            txtBerat_barang.Text = mydata.berat_barang
    ...
    Private Sub txtHarga_TextChanged(sender As Object, e As EventArgs) Handles txtBerat_barang.TextChanged
